...
elseif ispc
  ...
  mex -v -R2018a -I../../liblo/lo -L../win_binaries -llo_static -lWs2_32 -liphlpapi osc_new_address.c
  mex -v -R2018a -I../../liblo/lo -L../win_binaries -llo_static -lWs2_32 -liphlpapi osc_free_address.c
  mex -v -R2018a -I../../liblo/lo -L../win_binaries -llo_static -lWs2_32 -liphlpapi osc_new_server.c
  mex -v -R2018a -I../../liblo/lo -L../win_binaries -llo_static -lWs2_32 -liphlpapi osc_free_server.c
  mex -v -R2018a -I../../liblo/lo -L../win_binaries -llo_static -lWs2_32 -liphlpapi osc_send.c
  mex -v -R2018a -I../../liblo/lo -L../win_binaries -llo_static -lWs2_32 -liphlpapi osc_recv.c
